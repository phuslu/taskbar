...
BOOL ShowPopupMenu()
{
    ...
    AppendMenu(hMenu, MF_STRING, WM_TASKBARNOTIFY_MENUITEM_SHOW, L"ÏÔÊ¾");
    AppendMenu(hMenu, MF_STRING, WM_TASKBARNOTIFY_MENUITEM_HIDE, L"Òþ²Ø");
    AppendMenu(hMenu, MF_STRING, WM_TASKBARNOTIFY_MENUITEM_EXIT, L"ÍË³ö");
    GetCursorPos(&pt);
